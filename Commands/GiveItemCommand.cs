    ...
    internal class GiveItemCommand : ChatCommand
    {
        ...
        public override void Execute(ref ConsoleSystem.Arg Arguments, ref string[] ChatArguments)
        {
            ...
            if (matches.Count == 1)
            {
                ...
                if (np == null)
                {
                    pl.MessageFrom(RustPP.Core.Name, yellow + "☢ " + red + "Coudln't find player!");
                    return;
                }
            ...
            else
            {
                ...
                pl.MessageFrom(Core.Name, string.Format(yellow + "☢ " + red + "Unsure about " + yellow + "{0}" + red + ". Please be more specific.", str));
            }
        }
    }
}