namespace RustPP.Commands
{
    ...
    public class LocationCommand : ChatCommand
    {
        ...
        public override void Execute(ref ConsoleSystem.Arg Arguments, ref string[] ChatArguments)
        {
            ...
            {
                pl.MessageFrom(Core.Name, yellow + "☢" + red + "Only administrators can get the location of other players.");
                return;
            }
        ...
        public bool GetLocationString(ref NetUser source, Fougerite.Player location, out string reply)
        {
            ...
            try
            {
                ...
                reply = string.Format("{3} coordinates are: X: " + cyan + "{0} " + white + "Y: " + cyan + "{1} " + white + "Z: " + cyan + "{2}", v3[0], v3[1], v3[2],
